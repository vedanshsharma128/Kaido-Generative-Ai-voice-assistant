...
#tokenize the command to get the song name
...
# This function takes an input string and a list of words to remove
...
# adb keyevent command is used to send key events to the device
